...
<a onclick="quickBox('<?php echo $product['product_id']; ?>', '<?php echo $type_of_slider; ?>');" class="quick-view quickview img-circle hidden-phone hidden-small-desktop hidden-tablet fancybox" href="#quickview-<?php echo $product['product_id']; ?>-<?php echo $type_of_slider; ?>">
    <?php
    if ($product['rating'] > 0) :
