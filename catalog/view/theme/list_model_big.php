...
?>
<section class="<?php echo (isset($homepage_mode) && $homepage_mode == 'boxed' ? 'boxed_home' : 'container'); ?> nopad-bottom product_widget_desktop">

    <section class="slider-products module <?php echo $type_of_slider; ?>">
            <h3>
