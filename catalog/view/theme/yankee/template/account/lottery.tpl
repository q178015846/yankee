...
$(document).ready(function(){
    //动态添加大转盘的奖品与奖品区域背景颜色
    turnplate.restaraunts = ["谢谢参与", "10闪币", "谢谢参与", "5闪币", "谢谢参与", "20M免费流量包", "谢谢参与 ", "30M免费流量包", "谢谢参与", "2闪币"];
...
<!--效果html开始-->
    ...
    <img src="catalog/view/javascript/lottery/rotate/images/1.png" id="shan-img" style="display:none;" />
    <img src="catalog/view/javascript/lottery/rotate/images/2.png" id="sorry-img" style="display:none;" />
    <div class="banner">
        <div class="turnplate" style="background-image:url(catalog/view/javascript/lottery/rotate/images/turnplate-bg.png);background-size:100% 100%;">
            <canvas class="item" id="wheelcanvas" width="422px" height="422px"></canvas>
            <img class="pointer" src="catalog/view/javascript/lottery/rotate/images/turnplate-pointer.png"/>
        </div>
    </div>
    </div>
<!--效果html结束-->
