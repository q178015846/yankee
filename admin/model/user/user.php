...
class ModelUserUser extends Model {
	...
	public function editUser($user_id, $data) {
		$this->db->query("UPDATE `" . DB_PREFIX . "user` SET username = '" . $this->db->escape($data['username']) . "', user_group_id = '" . (int)$data['user_group_id'] . "', fullname = '" . $this->db->escape($data['fullname']) . "', email = '" . $this->db->escape($data['email']) . "', image = '" . $this->db->escape($data['image']) . "', status = '" . (int)$data['status'] . "', openid = '" . $data['openid'] . "' WHERE user_id = '" . (int)$user_id . "'");
	...
	public function getUserByOpenid($openid) {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "user` WHERE openid = '" . $this->db->escape($openid) . "'");
