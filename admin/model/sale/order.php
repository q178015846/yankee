...
class ModelSaleOrder extends Model {
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.order_id, o.fullname AS customer, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS status, o.shipping_code, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified,o.shipping_order_code FROM `" . DB_PREFIX . "order` o";
	...
	public function createShippingCode($order_id,$shipping_order_code,$shipping_order_company="") {
		$order_info = $this->getOrder($order_id);

		if ($order_info) {

			$this->db->query("UPDATE `" . DB_PREFIX . "order` SET shipping_order_company = '".$shipping_order_company."',shipping_order_code = '" . $shipping_order_code . "' WHERE order_id = '" . (int)$order_id . "'");
